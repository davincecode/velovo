...
export const Profile: React.FC = () => {
  ...
  if (loading || !profileData) {
    return (
      <IonPage>
        <IonHeader><IonToolbar><IonTitle>Edit Profile</IonTitle></IonToolbar></IonHeader>
        <IonContent className="ion-padding" style={{ textAlign: 'center' }}><IonSpinner /></IonContent>
      </IonPage>
    );
  }
  ...
  return (
    <IonPage>
      <IonHeader><IonToolbar><IonTitle>Edit Profile</IonTitle><IonButtons slot="end"><IonButton routerLink="/settings"><IonIcon slot="icon-only" icon={cog} /></IonButton></IonButtons></IonToolbar></IonHeader>
      <IonContent className="ion-padding">
        <form onSubmit={(e) => { e.preventDefault(); handleSave(); }}>
          ...
          <IonList>
            <IonListHeader><IonLabel>Ride Preferences</IonLabel></IonListHeader>
          ...
          {profileData.bike_setup.map((bike, index) => (
            <IonCard key={index}>
              <IonCardHeader onClick={() => toggleBikeCard(index)} style={{ cursor: 'pointer' }}>
                <IonCardTitle>Bike {index + 1}: {bike.bike_name || 'New Bike'}<IonButton fill="clear" color="danger" onClick={(e) => {e.stopPropagation(); removeBike(index)}} slot="end"><IonIcon icon={trash} /></IonButton><IonIcon icon={bikeCardVisibility[index] ? chevronUp : chevronDown} slot="end" /></IonCardTitle>
              </IonCardHeader>
          ...
          <IonList>
            <IonListHeader><IonLabel>Performance Metrics</IonLabel></IonListHeader>
          ...
          <IonList>
            <IonListHeader><IonLabel>Training Profile</IonLabel></IonListHeader>
          ...
          <IonList>
            <IonListHeader><IonLabel>Health & Lifestyle</IonLabel></IonListHeader>
          ...
          <IonList>
            <IonListHeader><IonLabel>Achievements</IonLabel></IonListHeader>
          ...
          <IonList>
            <IonListHeader><IonLabel>Future Intentions</IonLabel></IonListHeader>
          ...
          <IonList>
            <IonListHeader><IonLabel>Personality Profile</IonLabel></IonListHeader>
